...
--
-- Claim/Verification Status Mix:
-- - VERIFIED: Servers with owner_id, is_verified=true, verified_at, verification_method (claimed and verified)
-- - CLAIMED (pending): Servers with owner_id, is_verified=false (claimed but not yet verified)
-- - UNCLAIMED: Servers with owner_id=NULL, is_verified=false (scraped servers waiting for claim)
-- ============================================

-- PvP Servers
-- PVPHT - VERIFIED (claimed and verified via MOTD)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=pvpht', 'https://pvpht.com', 'https://discord.gg/pvpht', id, '1.0.0', false, 0, 100, 0.0, 15231, 58450, true, true, NOW() - INTERVAL '340 days', NULL, '22222222-2222-2222-2222-222222222222', NULL, NULL, 'MOTD', NOW() - INTERVAL '330 days'
FROM categories WHERE slug = 'pvp'
ON CONFLICT (id) DO NOTHING;

-- EliteHytale - VERIFIED (claimed and verified via DNS_TXT)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=hytown', 'https://hytown.org', 'https://discord.gg/hytown', id, '1.0.0', false, 0, 150, 0.0, 8934, 32100, false, false, NOW() - INTERVAL '300 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'survival'
ON CONFLICT (id) DO NOTHING;

-- Horizons SMP - CLAIMED but NOT VERIFIED (pending verification)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1493711662062-fa541f7f3d24?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=2b2h', NULL, 'https://discord.gg/2b2h', id, '1.0.0', false, 0, 500, 0.0, 21567, 67800, true, false, NOW() - INTERVAL '200 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'survival'
ON CONFLICT (id) DO NOTHING;

-- Minigames Servers
-- Hytale Party - VERIFIED (claimed and verified via FILE_UPLOAD)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=hylore', 'https://hylore.com', 'https://discord.gg/hylore', id, '1.0.0', false, 0, 300, 0.0, 28432, 145600, true, true, NOW() - INTERVAL '260 days', NULL, '66666666-6666-6666-6666-666666666666', NULL, NULL, 'DNS_TXT', NOW() - INTERVAL '250 days'
FROM categories WHERE slug = 'rpg'
ON CONFLICT (id) DO NOTHING;

-- Runeteria - VERIFIED (claimed and verified via MOTD)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
Master the Runefall!',
'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=runefall', 'https://runefall.net', 'https://discord.gg/runefall', id, '1.0.0', false, 0, 150, 0.0, 12345, 45600, false, false, NOW() - INTERVAL '75 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'rpg'
ON CONFLICT (id) DO NOTHING;

-- Creative Servers
-- Hytale Box - VERIFIED (claimed and verified via FILE_UPLOAD)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
Show your skills!',
'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=hystrix', 'https://hystrix.gg', 'https://discord.gg/hystrix', id, '1.0.0', false, 0, 100, 0.0, 9876, 34500, false, false, NOW() - INTERVAL '140 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'creative'
ON CONFLICT (id) DO NOTHING;

-- Adventure Servers
-- Dogecraft - VERIFIED (claimed and verified via DNS_TXT)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1490730141103-6cac27abb37f?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=hyfable', 'https://hyfable.com', 'https://discord.gg/hyfable', id, '1.0.0', false, 0, 100, 0.0, 8765, 31200, false, false, NOW() - INTERVAL '55 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'adventure'
ON CONFLICT (id) DO NOTHING;

-- Modded Servers
-- HyFyve - CLAIMED but NOT VERIFIED (pending verification)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
Automate everything!',
'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=hyfyve', 'https://hyfyve.net', 'https://discord.gg/hyfyve', id, '1.0.0', false, 0, 100, 0.0, 11234, 42100, false, false, NOW() - INTERVAL '85 days', NULL, 'b2b2b2b2-b2b2-b2b2-b2b2-b2b2b2b2b2b2', NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'modded'
ON CONFLICT (id) DO NOTHING;

-- Old Stronghold - UNCLAIMED (scraped server)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=oldstronghold', 'https://oldstronghold.nl', 'https://discord.gg/oldstronghold', id, '1.0.0', false, 0, 80, 0.0, 7654, 28900, false, false, NOW() - INTERVAL '65 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'modded'
ON CONFLICT (id) DO NOTHING;

-- International Servers
-- Hyspania - CLAIMED but NOT VERIFIED (pending verification)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=hyspania', 'https://hyspania.net', 'https://discord.gg/hyspania', id, '1.0.0', false, 0, 150, 0.0, 9876, 38700, false, false, NOW() - INTERVAL '120 days', NULL, 'dddddddd-dddd-dddd-dddd-dddddddddddd', NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'survival'
ON CONFLICT (id) DO NOTHING;

-- Inter World [RU] - UNCLAIMED (scraped server)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
Присоединяйся к нам!',
'https://images.unsplash.com/photo-1534088568595-a066f410bcda?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=interworld', 'https://interworld.fun', 'https://discord.gg/interworld', id, '1.0.0', false, 0, 200, 0.0, 8765, 34500, false, false, NOW() - INTERVAL '100 days', NULL, NULL, NULL, NULL, NULL, NULL
FROM categories WHERE slug = 'survival'
ON CONFLICT (id) DO NOTHING;

-- PrimeTale - VERIFIED (claimed and verified via MOTD)
INSERT INTO servers (id, name, slug, ip_address, port, short_description, description, banner_url, icon_url, website_url, discord_url, category_id, version, is_online, player_count, max_players, uptime_percentage, vote_count, view_count, is_featured, is_verified, created_at, last_pinged_at, owner_id, preferred_query_protocol, query_port, verification_method, verified_at)
...
'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&h=400&fit=crop', 'https://api.dicebear.com/7.x/identicon/svg?seed=primetale', 'https://primetale.net', 'https://discord.gg/primetale', id, '1.0.0', false, 0, 300, 0.0, 14567, 56700, true, true, NOW() - INTERVAL '80 days', NULL, 'ffffffff-ffff-ffff-ffff-ffffffffffff', NULL, NULL, 'MOTD', NOW() - INTERVAL '70 days'
FROM categories WHERE slug = 'minigames'
ON CONFLICT (id) DO NOTHING;
...
-- 5 recent votes
--
-- Server Claim/Verification Status Distribution:
-- VERIFIED (9 servers): PVPHT (MOTD), EliteHytale (DNS_TXT), Hytale Party (FILE_UPLOAD),
--                       CozyTale (EMAIL), Hylore (DNS_TXT), Runeteria (MOTD),
--                       Hytale Box (FILE_UPLOAD), Dogecraft (DNS_TXT), PrimeTale (MOTD)
-- CLAIMED but NOT VERIFIED (3 servers): Horizons SMP, HyFyve, Hyspania
-- UNCLAIMED (7 servers): Hytown, 2B2H, Runefall, HyStrix, Hyfable, Old Stronghold, Inter World [RU]
--
-- Verification Methods Used:
-- - MOTD: 4 servers (PVPHT, Runeteria, PrimeTale, + 1 more)
-- - DNS_TXT: 3 servers (EliteHytale, Hylore, Dogecraft)
-- - FILE_UPLOAD: 2 servers (Hytale Party, Hytale Box)
-- - EMAIL: 1 server (CozyTale - owner email hello@cozytale.us matches server domain)
